<template>
    ...
    <v-container>
        ...
        <v-col xl="9">
        <v-card v-if="loaded" dark class="blue-grey darken-3">
            <v-tabs
            v-model="tab"
            ...
            <v-tabs-items v-model="tab" >
                <v-tab-item
                    v-for="category in Object.keys(commands)"
                    :key="category" class="blue-grey darken-3"
                >
                    <v-container class="pa-5" >
                        <v-expansion-panels v-model="panels">
                            <v-expansion-panel
                                ...
                                class=""
                            >
                                <v-expansion-panel-header class="text-capitalize">{{command.name}}</v-expansion-panel-header>
                                <v-expansion-panel-content >
                                    <p>{{command.description}}</p>
